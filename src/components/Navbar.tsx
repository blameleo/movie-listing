...
export default function Navbar(props: NavbarProps) {
  ...
  return (
    <nav className="border-b border-gray-500 py-4 text-white flex items-center justify-between gap-x-10">
      <h1
        onClick={() => {
          props.setSearchTerm(props.searchTerm);
          navigate("/");
        }}
        className="font-semibold sm:text-xl flex items-center cursor-pointer"
      >
        {" "}
        <svg
          fill="#ffffff"
